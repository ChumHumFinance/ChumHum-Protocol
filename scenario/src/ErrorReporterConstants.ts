...
const BUMControllerErrorReporter = {
  Error: [
    'NO_ERROR',
    'UNAUTHORIZED'
  ],
...
export const BUMControllerErr = parseEnum(BUMControllerErrorReporter);
export const BUMVaultErr = parseEnum(BUMVaultErrorReporter);
