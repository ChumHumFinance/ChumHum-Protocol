...
const ChumHumPriceOracle = getContract('ChumHumPriceOracle');
...
export async function buildPriceOracle(world: World, from: string, event: Event): Promise<{world: World, priceOracle: PriceOracle, priceOracleData: PriceOracleData}> {
  const fetchers = [
    new Fetcher<{}, PriceOracleData>(`
        ...
        * "ChumHum " - ChumHum price 
          * E.g. "PriceOracle Deploy ChumHumPriceOracle"
      `,
      "ChumHumPriceOracle",
      [
      ],
      async (world, {}) => {
        ...
        // const feedAddress = "0xDA7a001b254CD22e46d3eAB04d937489c93174C3";
        //matic 
        // const feedAddress = "0x56e2898e0ceff0d1222827759b56b28ad812f92f";
        
        return {
          invokation: await ChumHumPriceOracle.deploy<PriceOracle>(world, from, []),
          description: "ChumHum Price Oracle"
        };
      }
    ),
