...
export interface BUMScenarioMethods extends BUMMethods {
...
export interface BUM extends Contract {
  methods: BUMMethods;
  name: string;
}

export interface BUMScenario extends Contract {
  methods: BUMScenarioMethods;
  name: string;
}
