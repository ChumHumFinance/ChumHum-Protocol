...
describe('Comptroller', () => {
  ...
  describe('_setLiquidationIncentive', () => {
    const initialIncentive = maticMantissa(1.0);
    const validIncentive = maticMantissa(1.1);
    const tooSmallIncentive = maticMantissa(0.99999);
    const tooLargeIncentive = maticMantissa(1.50000001);
