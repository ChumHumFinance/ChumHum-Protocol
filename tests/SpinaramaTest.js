...
describe('Spinarama', () => {
  ...
  describe('#mintMint', () => {
    it('should succeed', async () => {
      ...
      await send(cToken.underlying, 'approve', [cToken._address, '0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF'], {from});
      await minerStop();
  ...
  describe('#mintRedeem', () => {
    it('should succeed', async () => {
      ...
      await send(cToken.underlying, 'harnessSetBalance', [from, 100], {from});
      await send(cToken.underlying, 'approve', [cToken._address, 10], {from});
      await send(cToken.comptroller.bum, 'approve', [cToken.comptroller._address, 100], {from});
      await minerStop();
  ...
  describe('#repayRepay', () => {
    it('should succeed', async () => {
      ...
      await send(cToken2, 'harnessSetExchangeRate', [maticMantissa(1)]);
      await send(cToken1.comptroller.bum, 'approve', [cToken1.comptroller._address, 100], {from});
