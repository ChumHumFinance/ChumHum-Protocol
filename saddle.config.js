...
module.exports = {
  ...
  networks: {                                               // Define configuration for each network
    development: {
      ...
      {env: "PROVIDER"},
        {ganache: {
          gasLimit: 20000000,
          gasPrice: 20000,
          defaultBalanceMATIC: 1000000000,
    ...
    bscmainnet: {
      providers: [
        {env: "PROVIDER"},
        {file: "~/.ethereum/bscmainnet-url"},                    // Load from given file with contents as the URL (e.g. https://infura.io/api-key)
        {http: "https://bscmainnet-eth.compound.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
      ...
      accounts: [
        {env: "ACCOUNT"},
        {file: `~/.ethereum/bscmainnet-${process.env['KEY']}`},
        {file: "~/.ethereum/bscmainnet"}                        // Load from given file with contents as the private key (e.g. 0x...)
      ]
    },
    bsctestnet: {
      providers: [
        {env: "PROVIDER"},
        {file: "~/.ethereum/bsctestnet-url"},                    // Load from given file with contents as the URL (e.g. https://infura.io/api-key)
        {http: "https://bsctestnet-eth.compound.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
      ...
      accounts: [
        {env: "ACCOUNT"},
        {file: `~/.ethereum/bsctestnet-${process.env['KEY']}`},
        {file: "~/.ethereum/bsctestnet"}                        // Load from given file with contents as the private key (e.g. 0x...)
      ]
    },
    matic: {
      providers: [
        {env: "PROVIDER"},
        {file: "~/.ethereum/matic-url"},                    // Load from given file with contents as the URL (e.g. https://infura.io/api-key)
        {http: "https://matic-eth.compound.finance"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
      ...
      accounts: [
        {env: "ACCOUNT"},
        {file: `~/.ethereum/matic-${process.env['KEY']}`},
